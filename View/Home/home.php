<div class="block block-light">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Click-n-Collect</h1><hr/>
            <p >Click-n-Collect est une solution qui a 
                pour but d'aider les commerces à continuer leurs activités en ces temps difficiles.
            </p>
            <p>
                Notre solution se veut simple et pratique d'utilisation pour être accesible aux plus grands nombre.
                Elle posséde une interface simple pour vous permettre de démarrer rapidement.
            </p>
                Nous personnalisons la solution pour chaque client, avec votre logo vos choix de couleurs et 
                nos composants personalisables.
            </p>
            <p>
                Nous avons choisi dans un premier temps d'agir localement via les commerces proche de chez nous.
                Nous voulons être proche de nos clients pour les accompagnés dans la digitalisation de leur commerces.
            </p>
